...
```{r}
 userinfoInputPig <- tibble(ID = 1:6, 
                     ...
                     howmanycatsinput = c(0, 1, 0, 0, 1, 0))
```
...
InputIndexifyPig2 <- userinfoInputPig |>
  ...
  mutate(howmanypigsinput = case_when(howmanypigsinput >= 1 ~ 2,
                                       howmanypigsinput == 0 ~ 1),
         howmanydogsinput = case_when(howmanydogsinput >= 1 ~ 0,
                                      howmanydogsinput ==0 ~ 1),
         howmanycatsinput = case_when(howmanycatsinput >= 1 ~ 0,
                                      howmanycatsinput ==0 ~ 1)) |>
